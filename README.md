...
networkx                  optional, only for fast_analysis.to_networkx() <br>
...
qudit-lc/ <br>
&emsp;&emsp;│ <br>
&emsp;&emsp;├── data/ <- Orbit folders written by orbits_mt (not tracked; 202 GB for d = 3, n = 8). <br>
&emsp;&emsp;&emsp;&emsp;├── orbits_d{d}_n{n}_separated/ <- All orbits for d the local dimension and n the number of particles. <br>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;├── orbit_i <- Edge list of orbit graph i, in the format read by nx.read_edgelist(). <br>
